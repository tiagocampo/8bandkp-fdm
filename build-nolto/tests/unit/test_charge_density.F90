...
#line 320 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
  call assertEqual(expected, total_charge, tolerance=0.01_dp * expected, &
 & location=SourceLocation( &
 & 'test_charge_density.pf', &
 & 320) )
  if (anyExceptions()) return
#line 321 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"

    ! Electron density should be positive at all points
#line 323 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
  call assertTrue(all(n_electron > 0.0_dp), message="All electron density values positive", &
 & location=SourceLocation( &
 & 'test_charge_density.pf', &
 & 323) )
  if (anyExceptions()) return
#line 324 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"

    ! Hole density: VB at E=-1.0, Fermi at +3.0 => f~1 => holes = 1-f ~ 0
    ! So hole density should be negligible
#line 327 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
  call assertTrue(all(n_hole < 1.0e10_dp), message="Hole density negligible (VB full)", &
 & location=SourceLocation( &
 & 'test_charge_density.pf', &
 & 327) )
  if (anyExceptions()) return
#line 328 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
...
#line 373 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
  call assertTrue(n_electron(5) > 0.0_dp, message="Localized state nonzero at p=5", &
 & location=SourceLocation( &
 & 'test_charge_density.pf', &
 & 373) )
  if (anyExceptions()) return
#line 374 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"

    ! All other points should be zero
#line 376 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
  call assertTrue(n_electron(1) < 1.0e6_dp, message="Density zero at p=1", &
 & location=SourceLocation( &
 & 'test_charge_density.pf', &
 & 376) )
  if (anyExceptions()) return
#line 377 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
#line 377 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
  call assertTrue(n_electron(2) < 1.0e6_dp, message="Density zero at p=2", &
 & location=SourceLocation( &
 & 'test_charge_density.pf', &
 & 377) )
  if (anyExceptions()) return
#line 378 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
#line 378 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
  call assertTrue(n_electron(3) < 1.0e6_dp, message="Density zero at p=3", &
 & location=SourceLocation( &
 & 'test_charge_density.pf', &
 & 378) )
  if (anyExceptions()) return
#line 379 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
#line 379 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
  call assertTrue(n_electron(4) < 1.0e6_dp, message="Density zero at p=4", &
 & location=SourceLocation( &
 & 'test_charge_density.pf', &
 & 379) )
  if (anyExceptions()) return
#line 380 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
#line 380 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
  call assertTrue(n_electron(6) < 1.0e6_dp, message="Density zero at p=6", &
 & location=SourceLocation( &
 & 'test_charge_density.pf', &
 & 380) )
  if (anyExceptions()) return
#line 381 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
#line 381 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
  call assertTrue(n_electron(7) < 1.0e6_dp, message="Density zero at p=7", &
 & location=SourceLocation( &
 & 'test_charge_density.pf', &
 & 381) )
  if (anyExceptions()) return
#line 382 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
#line 382 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
  call assertTrue(n_electron(8) < 1.0e6_dp, message="Density zero at p=8", &
 & location=SourceLocation( &
 & 'test_charge_density.pf', &
 & 382) )
  if (anyExceptions()) return
#line 383 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
#line 383 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
  call assertTrue(n_electron(9) < 1.0e6_dp, message="Density zero at p=9", &
 & location=SourceLocation( &
 & 'test_charge_density.pf', &
 & 383) )
  if (anyExceptions()) return
#line 384 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"

    ! Hole density should be zero (no VB subbands)
#line 386 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
  call assertTrue(all(n_hole < 1.0e6_dp), message="Hole density zero (no VB)", &
 & location=SourceLocation( &
 & 'test_charge_density.pf', &
 & 386) )
  if (anyExceptions()) return
#line 387 "/data/8bandkp-fdm/tests/unit/test_charge_density.pf"
...
function test_charge_density_suite() result(suite)
   ...
   if(allocated(t)) deallocate(t)
   allocate(t, source=TestMethod('test_wire_normalization', &
      test_wire_normalization))
   call suite%addTest(t)

   if(allocated(t)) deallocate(t)
   allocate(t, source=TestMethod('test_wire_localized_state', &
      test_wire_localized_state))
   call suite%addTest(t)
