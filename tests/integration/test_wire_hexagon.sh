#!/bin/bash
# COVERAGE: observable=CB_ground_state geometry=wire_hexagon material=GaAs
# Integration test: wire hexagonal geometry regression
...
echo "PASS: wire hexagon eigenvalues match golden data"
